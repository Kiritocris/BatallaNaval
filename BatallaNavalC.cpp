...
// BatallaNavalC.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CBatallaNavalCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CBatallaNavalCApp

CBatallaNavalCApp::CBatallaNavalCApp()
{
...
// Único objeto CBatallaNavalCApp

CBatallaNavalCApp theApp;


// Inicialización de CBatallaNavalCApp

BOOL CBatallaNavalCApp::InitInstance()
{
